...
export function createDom() {
  return {
    ...
    fitSizeRow: requiredElement<HTMLDivElement>('fitSizeRow'),
    fitSizeSlider: requiredElement<HTMLInputElement>('fitSizeSlider'),
    fitSizeValEl: requiredElement<HTMLSpanElement>('fitSizeVal'),
    fitNoUpscaleRow: requiredElement<HTMLDivElement>('fitNoUpscaleRow'),
    fitNoUpscaleToggle: requiredElement<HTMLInputElement>('fitNoUpscaleToggle'),
    ...
    zoomLabel: requiredElement<HTMLSpanElement>('zoomLabel'),
